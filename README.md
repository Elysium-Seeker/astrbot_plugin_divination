...
- 版本： [v0.2.13](https://github.com/Elysium-Seeker/astrbot_plugin_tarot/releases/tag/v0.2.13)
...
1. [/tarot 问题] 进入多牌占卜流程：静心引导 -> 洗牌切牌 -> 匹配牌阵 -> 用户输入编号抽牌 -> 展示牌面 -> Markdown 风格整体分析卡片。
