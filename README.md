...
- 版本： [v0.2.14](https://github.com/Elysium-Seeker/astrbot_plugin_tarot/releases/tag/v0.2.14)
...
5. 若 Markdown 分析卡片出现乱码，请配置 `markdown_card_font_path` 指向本机可用中文字体（ttf/ttc）。
...
10. [markdown_card_font_path 配置] 可指定卡片渲染字体路径（ttf/ttc），用于避免中文乱码。
