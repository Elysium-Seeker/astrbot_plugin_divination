...
本插件的前身逻辑与塔罗牌资源最初参考并截取自以下项目，特此致谢：
- [XziXmn/astrbot_plugin_tarot](https://github.com/XziXmn/astrbot_plugin_tarot)
- [真寻bot插件库/tarot](https://github.com/AkashiCoin/nonebot_plugins_zhenxun_bot)
- [haha114514/tarot_hoshino](https://github.com/haha114514/tarot_hoshino)
- [hMinatoAquaCrews/nonebot_plugin_tarot](https://github.com/MinatoAquaCrews/nonebot_plugin_tarot)
