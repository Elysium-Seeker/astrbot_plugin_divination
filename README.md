...
🧰 [v0.2.1](https://github.com/yzjmxy/astrbot_plugin_tarot)
...
1. [占卜 问题] 进入多牌占卜流程：静心引导 -> 洗牌切牌 -> 匹配牌阵 -> 用户输入编号抽牌 -> 单牌+整体解读。

2. [塔罗牌 问题] 进入单张抽牌流程，并提供单牌+整体解读。

3. [抽牌 编号1 编号2 ...] 根据提示输入编号完成抽牌与翻牌。

4. [占卜记录 数量] 查看你的最近占卜记录（默认 3 条，最多 10 条）。

5. [开启/关闭群聊转发] 切换群聊转发模式。
