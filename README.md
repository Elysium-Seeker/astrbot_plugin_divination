...
- 版本： [v0.2.21](https://github.com/Elysium-Seeker/astrbot_plugin_tarot/releases/tag/v0.2.21)
...
6. 如需指定中文字体，可设置 `markdown_card_font_path` 指向本机 ttf/ttc 字体文件。
7. 若不需要卡片渲染，可将 `enable_markdown_card` 设为 `false` 回退纯文本分析。
8. Linux/容器若出现中文方框，可安装 `fonts-noto-cjk` 或 `fonts-wqy-zenhei`。
