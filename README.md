...
🧰 [v0.2.4](https://github.com/Elysium-Seeker/astrbot_plugin_tarot)
...
4. [抽牌 编号1 编号2 ...] 根据提示输入编号完成抽牌与翻牌（默认从该主题全部可抽牌中选择）。

5. [占卜记录 数量] 查看你的最近占卜记录（默认 3 条，最多 10 条）。

6. [开启/关闭群聊转发] 切换群聊转发模式。
