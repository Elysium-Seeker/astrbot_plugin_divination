...
- 版本： [v0.2.25](https://github.com/Elysium-Seeker/astrbot_plugin_tarot/releases/tag/v0.2.25)

## 更新日志
- **v0.2.25**: 追问改为单一 `/追问` 两阶段流程：先提交追问问题，再按提示从剩余牌中抽 1-2 张说明牌并解读；同题不重洗牌、不补位。
...
10. [追问 问题] 发起同题追问，系统会提示你从剩余牌中抽 1-2 张说明牌（随机决定抽 1 张或 2 张）。

11. [追问 编号1 编号2 ...] 在追问提示后输入说明牌编号；若编号与之前已抽牌重复，会提示重抽。
