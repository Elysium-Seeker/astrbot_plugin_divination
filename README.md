...
- 版本： [v0.2.18](https://github.com/Elysium-Seeker/astrbot_plugin_tarot/releases/tag/v0.2.18)
...
5. 本插件使用 Playwright 进行高质量 Markdown 分析卡片渲染，安装依赖后需 在机器上执行 playwright install chromium 安装浏览器。
