...
# We also need to update the card_element selector in main.py to select .tarot-card instead of .card
main_code = main_code.replace("card_element = await page.query_selector('.card')", "card_element = await page.query_selector('.tarot-card')")
...
meta = meta.replace('0.2.16', '0.2.17')
with open('metadata.yaml', 'w', encoding='utf-8') as f:
    f.write(meta)

with open('README.md', 'r', encoding='utf-8') as f:
    readme = f.read()
readme = readme.replace('v0.2.16', 'v0.2.17')
